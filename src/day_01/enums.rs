...
pub fn enums_details() {
    ...
    let payment = PaymentMethod::Crypto { coin: "S".to_string(), address: "0x124".to_string() };
    ...
    match payment {
        ...
        PaymentMethod::Transfer(val) if val == "Successful".to_string() => println!("This is {:#?}", PaymentMethod::Transfer("Successful".to_string())),
        PaymentMethod::Crypto {coin: val, address: val2} if val == "S" && val2 == "0x124" => println!("Pay with crypto"),
